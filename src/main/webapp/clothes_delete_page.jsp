    ...
    <form action="clodelete" method="post"> 
        <table border="1">
            ...
            <tr>
                <td>Name:</td>
                <td>
                    <input type="text" name="item_name" value="<%= name %>" readonly>
                </td>
            </tr>
            <tr>
                <td>Quantity:</td>
                <td>
                    <input type="text" name="item_qty" value="<%= qty  %>"readonly>
                </td>
            </tr>
            <tr>
                <td>Price:</td>
                <td>
                    <input type="text" name="item_price" value="<%=price %>"readonly>
                </td>
            </tr>
            <tr>
                <td colspan="2">
